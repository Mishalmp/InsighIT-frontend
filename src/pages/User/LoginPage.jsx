...
function LoginPage() {
  ...
  return (
    ...
    <Card className="bg-gray-100 min-h-screen">
  ...
  <CardBody className='grid md:grid-cols-2 bg-white shadow-2xl rounded-lg max-w-5xl md:mt-20 lg:ml-48 mt-0 h-auto md:h-[35rem]'>
    <div className="bg-cover flex items-center justify-center">
      <img className='hidden md:block h-[25rem] m-5 w-96' src={Bloggingimg}  alt="Blog img" />
    </div>
    <div className="bg-white  md:ml-10 w-full  md:w-96 h-auto md:h-[29rem] mt-10 p-8 rounded shadow-2xl">
      <h2 className="text-2xl font-semibold text-center md:text-left text-indigo-600">Login</h2>
